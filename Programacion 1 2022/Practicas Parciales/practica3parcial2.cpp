...
void porcentajeBateria(int &bateria, int cantidadMetros)
{
...
void cantMetrosRecorridos(char direccion, int &totalMetrosRecorridos, int cantidadMetros)
{
    if (direccion == 'r')
    {
...
int main(){
 ...
 {  
    ...
    //bateria
    porcentajeBateria(bateria, cantidadMetros);
    cout << "El porcentaje de la bateria es: " << bateria << endl;
    
    //metrosRecorridos = izquierda - o derecha +
    cantMetrosRecorridos(direccion, totalMetrosRecorridos, cantidadMetros);
